...
if __name__ == "__main__":
    ...
    hard_result = hard_ground(nlp, concept_vocab, 'Method 2 of 4: Requesting a Raise or Promotion (...) 4. State what you have contributed to the company. (...) By doing it this way, it is going to show that you have done your job and been an asset, thus the raise is well-deserved. (...) * If you believe your continuity of time working at this company warrants a raise or promotion, say that as well. It is best to tell them all the reasons you believe you deserve this increase.')
    print(hard_result)

    result = ground_mention_concepts(args, nlp, matcher, 'Method 2 of 4: Requesting a Raise or Promotion (...) 4. State what you have contributed to the company. (...) By doing it this way, it is going to show that you have done your job and been an asset, thus the raise is well-deserved. (...) * If you believe your continuity of time working at this company warrants a raise or promotion, say that as well. It is best to tell them all the reasons you believe you deserve this increase.')
    print(result)
    print(len(result))
    sentence_answer = ground_mention_concepts(args, nlp, matcher, 'filters')
