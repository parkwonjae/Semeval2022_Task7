...
def train(args):
    ...
    # )
    train_dataset = load_pickle_data(args)
    ...
    # )
    dev_dataset = load_pickle_data(args)
...
def test_test(args):
    ...
    #bert_multi_task_classification = BertForMultiTaskClassification.from_pretrained(args.rcgn_model_path, config=bert_config)
